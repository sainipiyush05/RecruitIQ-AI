...
const stages = [
  ...
  },
  {
    ...
    desc: 'Uses precomputed sentence-transformers/all-MiniLM-L6-v2 dense embeddings and local BM25 indexes to return dynamic scores across massive pools in under 2 seconds.',
    color: '#4FACFE',
    terminalLines: [
      { text: '$ recruitiq rank --pool=100000 --method=hybrid', type: 'cmd' },
      { text: '[INDEX] Loading BM25 lexical index (4.2 GB)...', type: 'info', delay: 500 },
      { text: '[INDEX] Loading all-MiniLM-L6-v2 dense vectors...', type: 'info', delay: 900 },
